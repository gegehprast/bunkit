...
> {
	...
	public query<T extends z.ZodTypeAny>(
		...
		return this as unknown as RouteBuilder<TPath, z.infer<T>, TBody, TParams, TResponse>
	}
	...
	public body<T extends z.ZodTypeAny>(
		...
		return this as unknown as RouteBuilder<TPath, TQuery, z.infer<T>, TParams, TResponse>
	}
	...
	public response<T extends z.ZodTypeAny>(
		...
		return this as unknown as RouteBuilder<TPath, TQuery, TBody, TParams, z.infer<T>>
	}
